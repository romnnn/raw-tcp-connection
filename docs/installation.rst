...
To install raw_tcp_connection, run this command in your terminal::
...
To install raw_tcp_connection from the sources, first clone the repository::

    $ git clone git://github.com/romnnn/raw_tcp_connection
